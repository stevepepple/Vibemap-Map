...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "a959878328262577614b";
...
eval("const express = __webpack_require__(/*! express */ \"express\");\n\nconst webpack = __webpack_require__(/*! webpack */ \"webpack\");\n\nconst webpackDevMiddleware = __webpack_require__(/*! webpack-dev-middleware */ \"webpack-dev-middleware\");\n\nconst webpackHotMiddleware = __webpack_require__(/*! webpack-hot-middleware */ \"webpack-hot-middleware\");\n\nconst webpackHotServerMiddleware = __webpack_require__(/*! webpack-hot-server-middleware */ \"webpack-hot-server-middleware\");\n\nconst serverConfig = __webpack_require__(/*! ../webpack/server.dev.js */ \"./webpack/server.dev.js\");\n\nconst clientConfig = __webpack_require__(/*! ../webpack/client.dev.js */ \"./webpack/client.dev.js\");\n\nconst app = express();\nconst compiler = webpack([clientConfig, serverConfig]);\nconst clientCompiler = compiler.compilers[0];\nconst publicPath = clientConfig.output.publicPath;\nconst options = {\n  publicPath,\n  stats: {\n    colors: true\n  }\n};\napp.use(webpackDevMiddleware(compiler, options));\napp.use(webpackHotMiddleware(clientCompiler));\napp.use(webpackHotServerMiddleware(compiler));\napp.listen(3000, () => {\n  console.log('Listening @ http://localhost:3000');\n});\n\n//# sourceURL=webpack:///./server/index.js?");
...
eval("const path = __webpack_require__(/*! path */ \"path\");\n\nconst webpack = __webpack_require__(/*! webpack */ \"webpack\");\n\nmodule.exports = {\n  name: 'server',\n  target: 'node',\n  devtool: 'source-map',\n  entry: path.resolve(__dirname, '../server/render.js'),\n  output: {\n    libraryTarget: 'commonjs2'\n  },\n  module: {\n    rules: [{\n      test: /\\.js$/,\n      exclude: /node_modules/,\n      use: 'babel-loader'\n    }, {\n      test: /\\.css$/i,\n      loader: 'css-loader',\n      //exclude: /node_modules/,\n      options: {\n        onlyLocals: true\n      }\n    }]\n  },\n  plugins: [// REQUIRED: To make dynamic css work correctly\n  new webpack.optimize.LimitChunkCountPlugin({\n    maxChunks: 1\n  }), new webpack.DefinePlugin({\n    'process.env': {\n      NODE_ENV: JSON.stringify('development')\n    }\n  })]\n};\n\n//# sourceURL=webpack:///./webpack/server.dev.js?");
